...
public class Parser {
	...
	public Command getCommand() {
		...
		return new Command(commands.getCommandWord(word1), word2); //giver commandword ud fra word 1 og opretter en ny command ud fra commandWord objektet og stringen
	}
