...
class RoomContainment {
	...
	/**
	 * The getEscapeRoom method is used to get the current state of the escapeRoom
	...
	/**
	 * The setEscapeRoom method is used to set the state of the boolean escapeRoom
	 * for a specific room
	 *
