...
public class ItemContainment {
    ...
    /**
     * The setNameOfRoomThatFitsThisKey method is used to set what room a key
     * can be used in
     *
     * @param nameOfRoomThatFitsThisKey is the name of the room a key can be
     * used in
     */
    ...
    /**
     * The getNameOfRoomThatFitsThisKey is used to get the String where a key
     * can be used
     *
     ...
     * used
     *
     * @param roomBoltcutterCanBeUsedIn a String equal to the name of a room
     * where the boltcutter can be used
     */
