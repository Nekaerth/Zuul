...
public class Flashlight implements Item {
	...
	private String name;
        ...
        /**
         * The constructor for the Flashlight class is called when we want to create objects
         * of the Flashlight class with a specific set of instace variables.
	...
	public Flashlight(boolean pickup, String name, boolean useable, int weight, int capacity, int charges) {
         ...
         * The isWeapon method returns false if called to an object of the Flashlight class
	...
	public boolean isWeapon() {
        ...
        /**
         * We override the instance method which is declare in the interface
         * The isKey method returns false if called to an object of the Flashlight class
         * @return will return a boolean as false
         */
	@Override
	public boolean isKey() {
        ...
        /**
         * We override the instance method which is declare in the interface
         * The isFlashlight method returns true if called to an object of the Flashlight class
	...
	public boolean isFlashlight() {
        ...
        /**
         * We override the instance method which is declare in the interface
         * The isMisc method returns false if called to an object of the Flashlight class
         * @return will return a boolean as false
         */
	@Override
	public boolean isMisc() {
        ...
        /**
         * We override the instance method which is declare in the interface
         * The isSpecial method returns false if called to an object of the flashlight class
         * @return will return a boolean as false
         */
	@Override
	public boolean isSpecial() {
        ...
        /**
         * We override the instance method which is declare in the interface
         * The getName method returns the name of the flashlight object
	...
	public String getName() {
        ...
        /**
         * We override the instance method which is declare in the interface
         * The isPickup method returns the boolean value declared when creating the flashlight object
	...
	public boolean isPickup() {
        ...
        /**
         * We override the instance method which is declare in the interface
         * The isUseable method returns the boolean value declared when creating the flashlight object
         * @return will return a boolean equal to what is declared when creating the object
         */
	@Override
	public boolean isUseable() {
        ...
        /**
         * We override the instance method which is declare in the interface
         * The getWeight method returns the int value declared when creating the flashlight object
	...
	public int getWeight() {
        ...
        /**
         * We override the instance method which is declare in the interface
         * The getCapacity method returns the int value declared when creating the flashlight object
	...
	public int getCapacity() {
        ...
        /**
         * The getCharges method returns the int value declared when creating the flashlight object
         * @return will return an int equal to what is declared when creating the object
         */
	public int getCharges() {
        ...
        /**
         * The subtractCharge method will subtract the int value of subCharge from charges
