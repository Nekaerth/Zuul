...
public class AlertBox {
	...
	/**
	 * Calls this method if you click the exitButton, ask if you are sure you want
	 * to quit
	 *
	...
	/**
	 * Checks if the code written, only consists of numbers, if so it returns
	 * true.
	 *
	 * @param text is a String that must contain nothing but numbers
	 * @return will return a boolean based on wheter or not the argument is
	 * acceptable
	 */
