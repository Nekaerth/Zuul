...
public class Room {
	 ...
	 *
	 *
	 * @param id is a unique identifier for each object of room
	 * @param numberRoom is a boolean that determines wether or not the room
	 * contains a hidden number
	 * @param lock is a boolean that detemine wether or not the room is locked
	 * @param escapeRoom is a boolean that determine wether or not the room is a
	 * room you can escape from
	 * @param name is a String that will determine the name of the room
	 * @param hidden is a boolean that determine wether or not the room is hidden
	 */
