...
public class GamePlay implements GUIdisplayable {
     ...
     *
     * @param item is the item from the use method
     * @return a boolean based on wether or not the the item was used
     * succsesfully
     */
    ...
    /**
     * The isCodeCorrect method is used to check, if the code entered when a
     * room with the boolean escapeRoom is true, is the correct code
     *
