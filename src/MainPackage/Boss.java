...
public class Boss extends Person {
    ...
    /**
     * The setCurrentMoveAtRandom method is used to randomize the attack which
     * the boss will make against the player in an encounter
     */
    ...
    /**
     * The playerHitBoss method is used during an encounter between a player and
     * a boss, it is used to chekc wheter the player chooses the right counter
     * attack against the bosses randomly chosen move
     *
     * @param player is the player that is in an encounter with the boss
     * @return will return a boolean based on wheter the chosen move was right
     * or wrong
     */
